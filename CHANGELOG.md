...
- Added a **Create Incident** command to file new BetterStack incidents with summary, description, requester email, and email/SMS/call notification preferences.
- Added an **Incidents** command to list active incidents with acknowledge, resolve, open in browser, and refresh actions.
